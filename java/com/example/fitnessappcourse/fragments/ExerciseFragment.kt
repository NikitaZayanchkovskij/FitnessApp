...
import com.example.fitnessappcourse.databinding.ExerciseBinding
import com.example.fitnessappcourse.utils.FragmentManager
import com.example.fitnessappcourse.utils.MainViewModel
import com.example.fitnessappcourse.utils.TimeUtils
...
class ExerciseFragment : Fragment() {
    ...
    private fun showNextExercise() = with(binding){
        if (exerciseCounter < exList?.size!!){
            ...
            imNext.setImageDrawable(GifDrawable(root.context.assets, "congratulations.gif"))
            tvNextName.text = getString(R.string.day_done)
        }
    }
